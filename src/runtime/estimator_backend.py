"""Generic estimator and planner-facing runtime contracts.

Nothing in this module imports a particle filter, planner implementation, or
simulator.  Runtime acquisition can therefore drive different estimators with
the same finalized :class:`~runtime.records.MeasurementRecord` sequence.
"""
