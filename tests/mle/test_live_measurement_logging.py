...
def _context() -> RunContext:
    ...
    return _build_measurement_run_context(
        ...
        obstacle_grid=grid,
        sources=[PointSource("Cs-137", (0.0, 0.0, 0.0), 12.0)],
        isotopes=("Cs-137", "Co-60"),
        sim_backend="analytic",
        spectrum_count_method="response_poisson",
        environment_mode="fixed",
        obstacle_layout_path="obstacle_layouts/fixed_obstacles.json",
        source_layout_path="source_layouts/demo_sources.json",
        output_tag="test",
